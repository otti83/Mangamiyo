 ...
 */
    ...
    public override func mouseDown(with event: NSEvent){
        Swift.print(self.clcikLeft())
    }
    
    func clcikLeft() -> Bool{
        delegate?.delegateClickLeft(self)
        return true
    }
    public override func rightMouseDown(with event: NSEvent){
        Swift.print(self.clcikRight())
    }
    
    func clcikRight() -> Bool{
...
extension ADragDropViewDelegate {
    func clickClickLeft(_ dragDropView: ADragDropView){
    }
    func clickClickRight(_ dragDropView: ADragDropView){
    }
    func dragDropView(_ dragDropView: ADragDropView, droppedFileWithURL  URL: URL) {
    }
